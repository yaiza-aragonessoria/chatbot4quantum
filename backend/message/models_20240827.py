...
class Message(models.Model):
    ...
    def save(self, *args, **kwargs):
        if self.role == 'user':
            ...
            if self.content.lower() == 'yes' or self.content.lower() == 'ok' or self.content.lower() == 'compute':
                print("parametersss =", self.previous_message.parameters)
                if self.content.lower() == 'ok':
                ...
                if category == 3:
                    ...
                    if logits[0][category] < 0.9 or gate_name is None:
                        previous_message = create_more_details_message(previous_message, self.user)
